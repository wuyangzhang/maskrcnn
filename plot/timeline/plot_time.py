...
'''
/home/wuyang/anaconda3/envs/maskrcnn_benchmark/bin/python plot_time.py in.jon
'''
...
class Timeline:
    ...
    def build(self):
        ...
        height = y_axis + self.max_label_height + 4 * self.text_fudge[1] - 100
    ...
    def create_eras(self, y_era, y_axis, height):
        ...
        for era in eras_data:
            ...
            self.drawing.add(
                self.drawing.text(name, insert=(0.5 * (x0 + x1), y_era - self.text_fudge[1]), stroke='none', fill=fill,
                                  font_family="Helevetica", font_size="6pt", text_anchor="middle"))
    ...
    def create_callouts(self):
        ...
        for event_date in sorted_dates:
            ...
            self.g_axis.add(
                self.drawing.text(event, insert=(x - self.callout_size[0] - self.text_fudge[0], y + self.text_fudge[1]),
                                  stroke='none', fill=event_color, font_family='Helevetica', font_size='6pt',
                                  text_anchor='end'))
